...
jQuery(document).ready(function ($) {
    ...
    // Bxslider Home
    $('.creativitycore-slider').bxSlider({
        auto: true,
        pager: true,
        mode: 'fade',
        controls: false,
    ...
    $('.widget_creativitycore-number-counter').one('inview', startKnob);
    ...
    $(window).load(function () {
        ...
        $(".creativitycore-preloader").fadeOut("slow");
    });
    ...
    if($('body').hasClass('page-template-tpl-home')){
        $('#fullpage').fullpage({
            ...
            //Custom selectors
            sectionSelector: '.creativitycore-main-section',
    ...
    function creativitycoreFocusForce(focEl){
        var _doc = document;
        setTimeout( function() {
    ...
    $('body').on('click keypress','.btn-transparent-toggle', function(){
        ...
        $('.site-footer').addClass('scroll-show').addClass('fp-show');
        creativitycoreFocusForce('.main-navigation ul li:first-child a');
    });
