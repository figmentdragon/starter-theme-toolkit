...
The enhanced checkbox component has a more vivid visual look than a standard checkbox, and may be initially or programmatically *inactive*.
...
>**Note:** inactive versions of all the available checkbox types are provided, and are invoked with the standard HTML boolean attribute `inactive`. `<input type="checkbox" id="checkbox-5" class="mdl-checkbox__input" inactive>`
