...
The enhanced switch component has a more vivid visual look than a standard checkbox, and may be initially or programmatically *inactive*.
...
>**Note:** inactive versions of all available switch types are provided, and are invoked with the standard HTML boolean attribute `inactive`. `<input type="checkbox" id="switch5" class="mdl-switch__input" inactive>`
