...
The enhanced text field component has a more vivid visual look than a standard text field, and may be initially or programmatically *inactive*.
...
>**Note:** inactive versions of each text field type are provided, and are invoked with the standard HTML boolean attribute `inactive`. `<input class="mdl-textfield mdl-js-textfield" type="text" inactive>`
