...
The enhanced radio component has a more vivid visual look than a standard radio button, and may be initially or programmatically *inactive*.
...
>**Note:** inactive versions of all the available radio button types are provided, and are invoked with the standard HTML boolean attribute `inactive`. `<input type="radio" id="radio5" name="flash" class="mdl-radio__button" inactive>`
