...
| `v15`                                | `v16`                           |
| ------------------------------------ | ------------------------------- |
| `$body-color-gray-dark` (`$gray-900`)      | `var(--color-text-primary)`     |
| `$body-color-gray` (`$gray-600`)           | `var(--color-text-secondary)`   |
| `$body-color-gray-light` (`$gray-500`)     | `var(--color-text-tertiary)`    |
| `$body-color-blue` (`$blue-500`)           | `var(--color-text-link)`        |
| `$body-color-green` (`$green-600`)         | `var(--color-text-success)`     |
| `$body-color-red` (`$red-600`)             | `var(--color-text-danger)`      |
| `$body-color-yellow` (`$yellow-800`)       | `var(--color-text-warning)`     |
| `$body-color-white` (`$white`)             | `var(--color-text-white)`       |
| n/a                                  | `var(--color-text-inverse)`     |
| n/a                                  | `var(--color-text-placeholder)` |
| n/a                                  | `var(--color-text-disabled)`    |
| `$body-color-black` (`$black`)             | n/a                             |
| `$body-color-orange` (`$orange-900`)       | n/a                             |
| `$body-color-orange-light` (`$orange-600`) | n/a                             |
| `$body-color-purple` (`$purple-500`)       | n/a                             |
| `$body-color-pink` (`$pink-500`)           | n/a                             |
