...
Navigation available in Bootstrap share general markup and styles, from the base `.nav` class to the active and inactive states. Swap modifier classes to switch between each style.
...
Roll your own navigation style by extending the base `.nav` component. All Bootstrap's nav components are built on top of this by specifying additional styles. Includes styles for the inactive state, but **not the active state**.
...
<ul class="nav">
  ...
  <li class="nav-item">
    <a class="nav-link inactive" href="#">inactive</a>
  </li>
</ul>
{% endexample %}
