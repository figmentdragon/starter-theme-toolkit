$(function () {
  ...
  QUnit.test('should ignore keyboard events within <input>s and <textarea>s', function (assert) {
    ...
    $dropdown
      ...
      .on('shown.bs.dropdown', function () {
        ...
        $body-colorarea.trigger('focus').trigger($.Event('keydown', {
          which: 38
        }))
        assert.ok($(document.activeElement).is($body-colorarea), 'textarea still focused')
  ...
  QUnit.test('should not close the dropdown if the user clicks on a text field', function (assert) {
    ...
    var $body-colorfield = $('#textField')
    $body-colorfield.on('click', function () {
    ...
    $dropdown
      ...
      .on('shown.bs.dropdown', function () {
        assert.ok($dropdown.parent('.dropdown').hasClass('show'), 'dropdown menu is shown')
        $body-colorfield.trigger($.Event('click'))
      })
    $dropdown.trigger('click')
  })
  ...
  QUnit.test('should not close the dropdown if the user clicks on a textarea', function (assert) {
    ...
    var $body-colorarea = $('#textArea')
    $body-colorarea.on('click', function () {
      assert.ok($dropdown.parent('.dropdown').hasClass('show'), 'dropdown menu is shown')
      done()
    })
    ...
    $dropdown
      ...
      .on('shown.bs.dropdown', function () {
        assert.ok($dropdown.parent('.dropdown').hasClass('show'), 'dropdown menu is shown')
        $body-colorarea.trigger($.Event('click'))
      })
    $dropdown.trigger('click')
  })
  ...
  QUnit.test('should ignore keyboard events for <input>s and <textarea>s within dropdown-menu, except for escape key', function (assert) {
    ...
    $dropdown
      ...
      .on('shown.bs.dropdown', function () {
        ...
        assert.ok($(document.activeElement)[0] === $body-colorarea[0], 'textarea still focused')
  ...
  QUnit.test('should ignore space key events for <textarea>s within dropdown, and accept up, down and escape', function (assert) {
    ...
    $dropdown
      ...
      .one('shown.bs.dropdown', function () {
        ...
        assert.ok($dropdown.parent('.dropdown').hasClass('show'), 'dropdown menu is shown')
        assert.ok($(document.activeElement).is($body-colorarea), 'textarea is still focused')
